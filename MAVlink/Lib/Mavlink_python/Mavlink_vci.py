...
Generated from: ('vci_minimal.xml,standard.xml,minimal.xml',)
...
# VEHICLE_ACTION
enums["VEHICLE_ACTION"] = {}
VEHICLE_ACTION_STOP = 0
enums["VEHICLE_ACTION"][0] = EnumEntry("VEHICLE_ACTION_STOP", """The vehicle stops""")
VEHICLE_ACTION_IDLE = 1
enums["VEHICLE_ACTION"][1] = EnumEntry("VEHICLE_ACTION_IDLE", """The vehicle do nothing""")
VEHICLE_ACTION_PAUSE = 2
enums["VEHICLE_ACTION"][2] = EnumEntry("VEHICLE_ACTION_PAUSE", """The vehicle temporarily stop its actions""")
VEHICLE_ACTION_RESUME = 3
enums["VEHICLE_ACTION"][3] = EnumEntry("VEHICLE_ACTION_RESUME", """The vehicle resume its actions if it was paused""")
VEHICLE_ACTION_MOVE_FWD = 4
enums["VEHICLE_ACTION"][4] = EnumEntry("VEHICLE_ACTION_MOVE_FWD", """The vehicle move forward for a certain distance""")
VEHICLE_ACTION_MOVE_BWD = 5
enums["VEHICLE_ACTION"][5] = EnumEntry("VEHICLE_ACTION_MOVE_BWD", """The vehicle move backward for a certain distance""")
VEHICLE_ACTION_ROTATE_R = 6
enums["VEHICLE_ACTION"][6] = EnumEntry("VEHICLE_ACTION_ROTATE_R", """The vehicle rotate right of n degrees""")
VEHICLE_ACTION_ROTATE_L = 7
enums["VEHICLE_ACTION"][7] = EnumEntry("VEHICLE_ACTION_ROTATE_L", """The vehicle rotate left of n degrees""")
VEHICLE_ACTION_CIRCLE = 8
enums["VEHICLE_ACTION"][8] = EnumEntry("VEHICLE_ACTION_CIRCLE", """The vehicle rotate left of n degrees""")
VEHICLE_ACTION_SQUARE = 9
enums["VEHICLE_ACTION"][9] = EnumEntry("VEHICLE_ACTION_SQUARE", """The vehicle rotate left of n degrees""")
VEHICLE_ACTION_ENUM_END = 10
enums["VEHICLE_ACTION"][10] = EnumEntry("VEHICLE_ACTION_ENUM_END", """""")

# CAMERA_DETECTION
enums["CAMERA_DETECTION"] = {}
CAMERA_DETECTION_APRILTAG_0 = 0
enums["CAMERA_DETECTION"][0] = EnumEntry("CAMERA_DETECTION_APRILTAG_0", """The camera detected the apriltag 0""")
CAMERA_DETECTION_APRILTAG_1 = 1
enums["CAMERA_DETECTION"][1] = EnumEntry("CAMERA_DETECTION_APRILTAG_1", """The camera detected the apriltag 1""")
CAMERA_DETECTION_APRILTAG_2 = 2
enums["CAMERA_DETECTION"][2] = EnumEntry("CAMERA_DETECTION_APRILTAG_2", """The camera detected the apriltag 2""")
CAMERA_DETECTION_APRILTAG_3 = 3
enums["CAMERA_DETECTION"][3] = EnumEntry("CAMERA_DETECTION_APRILTAG_3", """The camera detected the apriltag 3""")
CAMERA_DETECTION_APRILTAG_4 = 4
enums["CAMERA_DETECTION"][4] = EnumEntry("CAMERA_DETECTION_APRILTAG_4", """The camera detected the apriltag 4""")
CAMERA_DETECTION_ENUM_END = 5
enums["CAMERA_DETECTION"][5] = EnumEntry("CAMERA_DETECTION_ENUM_END", """""")

# DEVICE_ID
enums["DEVICE_ID"] = {}
DEVICE_ID_STM32 = 0
enums["DEVICE_ID"][0] = EnumEntry("DEVICE_ID_STM32", """ID of the STM32 card""")
DEVICE_ID_RASPBERRYPI = 1
enums["DEVICE_ID"][1] = EnumEntry("DEVICE_ID_RASPBERRYPI", """ID of the RASPBERRYPI card""")
DEVICE_ID_GCS = 2
enums["DEVICE_ID"][2] = EnumEntry("DEVICE_ID_GCS", """ID of the ground control station""")
DEVICE_ID_ENUM_END = 3
enums["DEVICE_ID"][3] = EnumEntry("DEVICE_ID_ENUM_END", """""")
...
enums["MAV_TYPE"][44] = EnumEntry("MAV_TYPE_ENUM_END", """""")
...
MAVLINK_MSG_ID_HEARTBEAT_VCI = 1
MAVLINK_MSG_ID_VEHICLE_COMMAND_ACTION = 2
MAVLINK_MSG_ID_SENSOR_CAMERA_DETECTION = 3
MAVLINK_MSG_ID_HEARTBEAT = 0
MAVLINK_MSG_ID_PROTOCOL_VERSION = 300


class MAVLink_heartbeat_vci_message(MAVLink_message):
    """
    The simplest message to indicate if a device is connected (UART,
    UDP, ...)
    """

    id = MAVLINK_MSG_ID_HEARTBEAT_VCI
    msgname = "HEARTBEAT_VCI"
    fieldnames = ["timestamp", "device_id"]
    ordered_fieldnames = ["timestamp", "device_id"]
    fieldtypes = ["uint64_t", "uint8_t"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"device_id": "DEVICE_ID"}
    ...
    def __init__(self, timestamp: int, device_id: int):
        MAVLink_message.__init__(self, MAVLink_heartbeat_vci_message.id, MAVLink_heartbeat_vci_message.msgname)
        self._fieldnames = MAVLink_heartbeat_vci_message.fieldnames
        self._instance_field = MAVLink_heartbeat_vci_message.instance_field
        self._instance_offset = MAVLink_heartbeat_vci_message.instance_offset
        self.timestamp = timestamp
        self.device_id = device_id

    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.timestamp, self.device_id), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_heartbeat_vci_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_vehicle_command_action_message(MAVLink_message):
    """
    This message indicates the command required by a user
    """

    id = MAVLINK_MSG_ID_VEHICLE_COMMAND_ACTION
    msgname = "VEHICLE_COMMAND_ACTION"
    fieldnames = ["timestamp", "vehicle_action"]
    ordered_fieldnames = ["timestamp", "vehicle_action"]
    fieldtypes = ["uint64_t", "uint8_t"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"vehicle_action": "VEHICLE_ACTION"}
    fieldunits_by_name: Dict[str, str] = {"timestamp": "us"}
    native_format = bytearray(b"<QB")
    orders = [0, 1]
    lengths = [1, 1]
    ...
    def __init__(self, timestamp: int, vehicle_action: int):
        MAVLink_message.__init__(self, MAVLink_vehicle_command_action_message.id, MAVLink_vehicle_command_action_message.msgname)
        self._fieldnames = MAVLink_vehicle_command_action_message.fieldnames
        self._instance_field = MAVLink_vehicle_command_action_message.instance_field
        self._instance_offset = MAVLink_vehicle_command_action_message.instance_offset
        self.timestamp = timestamp
        self.vehicle_action = vehicle_action

    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.timestamp, self.vehicle_action), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_vehicle_command_action_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_sensor_camera_detection_message(MAVLink_message):
    """
    Message giving the id of the identified april tag
    """

    id = MAVLINK_MSG_ID_SENSOR_CAMERA_DETECTION
    msgname = "SENSOR_CAMERA_DETECTION"
    fieldnames = ["timestamp", "identified_apriltag"]
    ordered_fieldnames = ["timestamp", "identified_apriltag"]
    fieldtypes = ["uint64_t", "uint8_t"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"identified_apriltag": "CAMERA_DETECTION"}
    fieldunits_by_name: Dict[str, str] = {"timestamp": "us"}
    native_format = bytearray(b"<QB")
    orders = [0, 1]
    lengths = [1, 1]
    ...
    def __init__(self, timestamp: int, identified_apriltag: int):
        MAVLink_message.__init__(self, MAVLink_sensor_camera_detection_message.id, MAVLink_sensor_camera_detection_message.msgname)
        self._fieldnames = MAVLink_sensor_camera_detection_message.fieldnames
        self._instance_field = MAVLink_sensor_camera_detection_message.instance_field
        self._instance_offset = MAVLink_sensor_camera_detection_message.instance_offset
        self.timestamp = timestamp
        self.identified_apriltag = identified_apriltag

    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.timestamp, self.identified_apriltag), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_sensor_camera_detection_message, "name", mavlink_msg_deprecated_name_property())
...
mavlink_map: Dict[int, Type[MAVLink_message]] = {
    MAVLINK_MSG_ID_HEARTBEAT_VCI: MAVLink_heartbeat_vci_message,
    MAVLINK_MSG_ID_VEHICLE_COMMAND_ACTION: MAVLink_vehicle_command_action_message,
    MAVLINK_MSG_ID_SENSOR_CAMERA_DETECTION: MAVLink_sensor_camera_detection_message,
...
class MAVLink(object):
    ...
    def heartbeat_vci_encode(self, timestamp: int, device_id: int) -> MAVLink_heartbeat_vci_message:
        """
        The simplest message to indicate if a device is connected (UART, UDP,
        ...)

        timestamp                 : Timestamp of the message [us] (type:uint64_t)
        device_id                 : Id of the sender device (type:uint8_t, values:DEVICE_ID)

        """
        return MAVLink_heartbeat_vci_message(timestamp, device_id)

    def heartbeat_vci_send(self, timestamp: int, device_id: int, force_mavlink1: bool = False) -> None:
        """
        The simplest message to indicate if a device is connected (UART, UDP,
        ...)
        ...
        """
        self.send(self.heartbeat_vci_encode(timestamp, device_id), force_mavlink1=force_mavlink1)

    def vehicle_command_action_encode(self, timestamp: int, vehicle_action: int) -> MAVLink_vehicle_command_action_message:
        """
        This message indicates the command required by a user

        timestamp                 : Timestamp of the message [us] (type:uint64_t)
        vehicle_action            : Vehicle action requested (type:uint8_t, values:VEHICLE_ACTION)

        """
        return MAVLink_vehicle_command_action_message(timestamp, vehicle_action)

    def vehicle_command_action_send(self, timestamp: int, vehicle_action: int, force_mavlink1: bool = False) -> None:
        """
        This message indicates the command required by a user
        ...
        """
        self.send(self.vehicle_command_action_encode(timestamp, vehicle_action), force_mavlink1=force_mavlink1)

    def sensor_camera_detection_encode(self, timestamp: int, identified_apriltag: int) -> MAVLink_sensor_camera_detection_message:
        """
        Message giving the id of the identified april tag

        timestamp                 : Timestamp of the message [us] (type:uint64_t)
        identified_apriltag        : Apriltag identified (type:uint8_t, values:CAMERA_DETECTION)

        """
        return MAVLink_sensor_camera_detection_message(timestamp, identified_apriltag)

    def sensor_camera_detection_send(self, timestamp: int, identified_apriltag: int, force_mavlink1: bool = False) -> None:
        """
        Message giving the id of the identified april tag
        ...
        """
        self.send(self.sensor_camera_detection_encode(timestamp, identified_apriltag), force_mavlink1=force_mavlink1)
